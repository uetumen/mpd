...
static int	NatSetCommand(Context ctx, int ac, char *av[], const void *arg);
...
static int
NatSetCommand(Context ctx, int ac, char *av[], const void *arg)
{
...
int
NatStat(Context ctx, int ac, char *av[], const void *arg)
{
    NatState	const nat = &ctx->bund->iface.nat;
