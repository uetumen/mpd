 ...
 */
  ...
  static int	MppcSetCommand(Context ctx, int ac, char *av[], const void *arg);
...
int
MppcStat(Context ctx, int ac, char *av[], const void *arg)
{
...
static int
MppcSetCommand(Context ctx, int ac, char *av[], const void *arg)
{
  MppcInfo	const mppc = &ctx->bund->ccp.mppc;
