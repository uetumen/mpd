 ...
 */
  ...
  static int	L2tpSetCommand(Context ctx, int ac, char *av[], const void *arg);
...
static int
L2tpSetCommand(Context ctx, int ac, char *av[], const void *arg)
{
    L2tpInfo		const l2tp = (L2tpInfo) ctx->lnk->info;
...
int
L2tpsStat(Context ctx, int ac, char *av[], const void *arg)
{
    struct l2tp_tun	*tun;
    struct ghash_walk	walk;
