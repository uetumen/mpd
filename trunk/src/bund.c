 ...
 */
  ...
  static int	BundSetCommand(Context ctx, int ac, char *av[], const void *arg);
...
int
BundCommand(Context ctx, int ac, char *av[], const void *arg)
{
    Bund	sb;
    int		j, k;
...
int
MSessionCommand(Context ctx, int ac, char *av[], const void *arg)
{
    int		k;
...
int
IfaceCommand(Context ctx, int ac, char *av[], const void *arg)
{
    int		k;
...
int
BundCreate(Context ctx, int ac, char *av[], const void *arg)
{
    Bund	b, bt = NULL;
    u_char	tmpl = 0;
    u_char	stay = 0;
...
int
BundDestroy(Context ctx, int ac, char *av[], const void *arg)
{
    Bund 	b;
...
int
BundStat(Context ctx, int ac, char *av[], const void *arg)
{
  Bund	sb;
  int	k, bw, tbw, nup;
  char	buf[64];
...
static int
BundSetCommand(Context ctx, int ac, char *av[], const void *arg)
{
    Bund	b = ctx->bund;
    int		i, val;
