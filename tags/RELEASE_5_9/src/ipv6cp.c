 ...
 */
  ...
  static int	Ipv6cpSetCommand(Context ctx, int ac, const char *const av[], const void *arg);
...
int
Ipv6cpStat(Context ctx, int ac, const char *const av[], const void *arg)
{
...
static int
Ipv6cpSetCommand(Context ctx, int ac, const char *const av[], const void *arg)
{
  Ipv6cpState		const ipv6cp = &ctx->bund->ipv6cp;
