 ...
 */
  ...
  static int	EapSetCommand(Context ctx, int ac, const char *av[], const void *arg);
...
int
EapStat(Context ctx, int ac, const char *av[], const void *arg)
{
...
static int
EapSetCommand(Context ctx, int ac, const char *av[], const void *arg)
{
  EapInfo	const eap = &ctx->lnk->lcp.auth.eap;
