 ...
 */
  ...
  extern int	ConsoleStat(Context ctx, int ac, char *av[], const void *arg);
  ...
  extern int	UserCommand(Context ctx, int ac, char *av[], const void *arg);
  extern int	UserStat(Context ctx, int ac, char *av[], const void *arg);
