...
/* Global variables */
  ...
  static int	RadiusSetCommand(Context ctx, int ac, const char *av[], const void *arg);
...
int
RadStat(Context ctx, int ac, const char *av[], const void *arg)
{
...
/* Set menu options */
static int
RadiusSetCommand(Context ctx, int ac, const char *av[], const void *arg) 
{
