 ...
 */
  ...
  extern int	BundStat(Context ctx, int ac, const char *av[], const void *arg);
  extern void	BundUpdateParams(Bund b);
  extern int	BundCommand(Context ctx, int ac, const char *av[], const void *arg);
  extern int	MSessionCommand(Context ctx, int ac, const char *av[], const void *arg);
  extern int	IfaceCommand(Context ctx, int ac, const char *av[], const void *arg);
  extern int	BundCreate(Context ctx, int ac, const char *av[], const void *arg);
  extern int	BundDestroy(Context ctx, int ac, const char *av[], const void *arg);
